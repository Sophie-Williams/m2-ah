...
config. BorderColor		= '#646464'
config. BorderStyle		= 'double'	// Any permitted CSS value, but I recommend 'solid', 'dotted' or 'dashed'
...
function tt_HideSrcTagsRecurs(dad)
{
	...
	// (.childNodes first since .children is bugous in old Safari versions)
